...
LABEL_DESCRIPTIONS = {
    "Activity": "Action, behavior, task, or functional activity.",
    "Administration": "Medication or treatment administration route or method.",
    "Age": "Patient age or age-like expression.",
    "Area": "Area, region, or location measurement.",
    "Biological_attribute": "Biological property or attribute.",
    "Biological_structure": "Body part, organ, tissue, or anatomical structure.",
    "Clinical_event": "Clinical event, encounter, episode, or health-related occurrence.",
    "Color": "Color descriptor.",
    "Coreference": "Expression that refers back to another entity.",
    "Date": "Calendar date or date-like expression.",
    "Detailed_description": "Detailed descriptive clinical modifier.",
    "Diagnostic_procedure": "Diagnostic test, imaging, exam, or measurement procedure.",
    "Disease_disorder": "Disease, disorder, diagnosis, or chronic condition.",
    "Distance": "Distance or length value.",
    "Dosage": "Medication amount, strength, or dose quantity.",
    "Duration": "Duration of a treatment, medication, symptom, or condition.",
    "Family_history": "Family history statement or inherited-risk mention.",
    "Frequency": "Medication, treatment, event, or symptom frequency.",
    "Height": "Height value.",
    "History": "Clinical history mention.",
    "Lab_value": "Laboratory result value including units when present.",
    "Mass": "Mass or weight-like measurement.",
    "Medication": "Medication, vaccine, supplement, or drug name.",
    "Nonbiological_location": "Non-anatomical location such as city, hospital, or place.",
    "Occupation": "Occupation or professional role.",
    "Other_entity": "Entity that does not fit a more specific MACCROBAT type.",
    "Other_event": "Event that does not fit a more specific MACCROBAT type.",
    "Outcome": "Clinical outcome, response, disposition, or prognosis.",
    "Personal_background": "Personal or social background information.",
    "Qualitative_concept": "Qualitative descriptor or concept.",
    "Quantitative_concept": "Numeric or measurable concept.",
    "Severity": "Severity descriptor.",
    "Sex": "Sex or gender mention.",
    "Shape": "Shape descriptor.",
    "Sign_symptom": "Sign, symptom, or patient-reported complaint.",
    "Subject": "Subject of a clinical statement.",
    "Texture": "Texture descriptor.",
    "Therapeutic_procedure": "Therapeutic, surgical, or treatment procedure.",
    "Time": "Clock time or time-of-day expression.",
    "Volume": "Volume value.",
    "Weight": "Weight value.",
}

LABEL_BY_CASEFOLD = {label.casefold(): label for label in ALLOWED_LABELS}
...
LABEL_PRIORITY = {
    ...
    "Therapeutic_procedure": 2,
    "Disease_disorder": 3,
    "Sign_symptom": 3,
    "Biological_structure": 4,
    "Area": 4,
    "Family_history": 5,
    "Outcome": 5,
    "Clinical_event": 6,
    "History": 6,
    "Biological_attribute": 7,
    "Personal_background": 7,
    "Occupation": 7,
    "Nonbiological_location": 7,
    "Severity": 8,
    "Qualitative_concept": 8,
    "Quantitative_concept": 8,
    "Activity": 9,
    "Other_entity": 10,
    "Other_event": 10,
}
...
def repair_offsets(input_text: str, entities: list[dict]) -> list[dict]:
    ...
    for entity in entities:
        ...
        label = LABEL_BY_CASEFOLD.get(raw_label.casefold())
        if label is None:
            continue
